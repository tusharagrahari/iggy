...
public readonly struct HeaderValue
{
    ...
    public new string ToString()
    {
        return Kind switch
        {
            ...
            HeaderKind.Int16 => BinaryPrimitives.ReadInt16LittleEndian(Value).ToString(),
            ...
            HeaderKind.Uint8 => Value[0].ToString(),
            HeaderKind.Uint16 => BinaryPrimitives.ReadUInt16LittleEndian(Value).ToString(),
